...
FILE="routes.txt"
tail -n +1 "$FILE" > $NEW_FILE
hdfs dfs -mkdir /user/w205/project/routes
hdfs dfs -put $NEW_FILE /user/w205/project/routes

FILE="stops.txt"
tail -n +1 "$FILE" > $NEW_FILE
hdfs dfs -mkdir /user/w205/project/stops
hdfs dfs -put $NEW_FILE /user/w205/project/stops

FILE="stop_times.txt"
tail -n +1 "$FILE" > $NEW_FILE
hdfs dfs -mkdir /user/w205/project/stop_times
hdfs dfs -put $NEW_FILE /user/w205/project/stop_times

FILE="trips.txt"
tail -n +1 "$FILE" > $NEW_FILE
hdfs dfs -mkdir /user/w205/project/trips
hdfs dfs -put $NEW_FILE /user/w205/project/trips
